...
Provide media retrieval service configuration.
...
---------|--------|---------|-------
 1.x.x   | 13     | 2.20    | Ansible 2.20, semantic versioning.
 0.x.x   | 12     | 2.18    | Pre-release migrations (old 12.x.x,13.x.x builds).
...
[f]: https://github.com/r-pufky/ansible_collection_arr/blob/main/LICENSE
[g]: https://galaxy.ansible.com/ui/repo/published/r_pufky/arr
